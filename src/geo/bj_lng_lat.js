...
class LngLat {
    ...
    wrap() {
    		/*
    		* ����Ҫ�Ѿ���ֵ������[-180,180]��2018/7/20 by LLZ
    		*/
     ...
     *
     *	������չ����radius���ѱ����ط������һ���㣬ת��һ�������� 2018/7/20 by LLZ
     */
    toBounds(radius: number) {
        ...
        */
        return new LngLatBounds(new LngLat(this.lng - radisu,this.lat - radius),
        		new LngLat(this.lng + radius,this.lat + radisu));
    }
