...
const Transform = require('../geo/bjtransform');
const Hash = require('./hash');

const bindHandlers = require('./bind_handlers');

const Camera = require('./camera');
const LngLat = require('../geo/bj_lng_lat');
...
import type {LngLatLike} from '../geo/bj_lng_lat';
...
class Map extends Camera {
    ...
    //    return this.transform.project(LngLat.convert(lnglat));
